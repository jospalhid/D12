...
@Transactional
public class ListSendSmsTest extends AbstractTest {

	/*
	 * Listar mis mensajes enviados - Manager
	 *
	...
	protected void template(String username, final Class<?> expected) {
		...
		try {
			...
			recieve.addAll(smsService.findMySendMessages(LoginService.getPrincipal().getId()));
